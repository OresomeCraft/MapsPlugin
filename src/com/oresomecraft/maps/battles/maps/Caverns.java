...
@Attributes(
        allowBuild = false,
        disabledDrops = {Material.BOW, Material.IRON_SWORD, Material.ARROW, Material.IRON_HELMET, Material.IRON_CHESTPLATE, Material.IRON_LEGGINGS, Material.IRON_BOOTS}
)
public class Caverns extends BattleMap {
