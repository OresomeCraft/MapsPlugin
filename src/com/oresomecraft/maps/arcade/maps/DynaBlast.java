...
public class DynaBlast extends ArcadeMap implements Listener {
     ...
     * redSpawns.add(new Location(w, -29, 65, -29, 0, 0));
     * redSpawns.add(new Location(w, 11, 65, -29, 0, 0));
     * redSpawns.add(new Location(w, -29, 65, 11, 0, 0));
     * redSpawns.add(new Location(w, 11, 65, 11, 0, 0));
     * <p/>
     * blueSpawns.add(new Location(w, 1, 65, 1, 0, 0));
     * blueSpawns.add(new Location(w, -19, 65, 1, 0, 0));
     * blueSpawns.add(new Location(w, -19, 65, -19, 0, 0));
     * blueSpawns.add(new Location(w, 1, 65, -19, 0, 0));
     * }
     */
