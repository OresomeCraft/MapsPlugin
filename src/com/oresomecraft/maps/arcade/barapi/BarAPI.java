package com.oresomecraft.maps.arcade.barapi;

import com.oresomecraft.maps.MapsPlugin;
import com.oresomecraft.maps.arcade.barapi.nms.FakeDragon;
...
public class BarAPI extends JavaPlugin implements Listener {
    ...
    public static void setMessage(final Player player, String message, int seconds) {
        ...
        timers.put(player.getUniqueId(), Bukkit.getScheduler().runTaskTimer(MapsPlugin.getInstance(), new BukkitRunnable() {
