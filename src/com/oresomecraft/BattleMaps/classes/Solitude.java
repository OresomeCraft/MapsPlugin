	...
	public void applyInventory(InventoryEvent event) {
		...
		if (par.equalsIgnoreCase(name)) {
			...
			if (TDM.isBlue(p.getName())) {
				...
				leather_helmet.setDisplayName(ChatColor.BLUE
						+ "StormCloak Helmet");
				...
				leather_boots.setDisplayName(ChatColor.BLUE
						+ "StormCloak Boots");
				...
				leather_pants.setDisplayName(ChatColor.BLUE
						+ "StormCloak Leggings");
				...
				leather_chestplate.setDisplayName(ChatColor.BLUE
						+ "StormCloak ChestPlate");
			...
			if (TDM.isRed(p.getName())) {
				...
				ItemMeta leather_helmet = LEATHER_HELMET.getItemMeta();
				leather_helmet
						.setDisplayName(ChatColor.RED + "Imperial Helmet");
				LEATHER_HELMET.setItemMeta(leather_helmet);
				...
				ItemMeta leather_pants = LEATHER_PANTS.getItemMeta();
				leather_pants.setDisplayName(ChatColor.RED
						+ "Imperial Leggings");
				LEATHER_PANTS.setItemMeta(leather_pants);

				// Sets chestplate name "Imperial ChestPlate"
				ItemMeta leather_chestplate = LEATHER_CHESTPLATE.getItemMeta();
				leather_chestplate.setDisplayName(ChatColor.RED
						+ "Imperial ChestPlate");
				LEATHER_CHESTPLATE.setItemMeta(leather_chestplate);
